...
public class ServerConfig {
    ...
    public boolean AGENT_DIALOGUE_SYSTEM_ENABLED;
    public String AGENT_DIALOGUE_ENABLED_TOPICS;
    public boolean AGENT_CONVERSATION_ENABLED;
    public boolean AGENT_CONVERSATION_SIMULATE_UNOBSERVED;
    public int AGENT_CONVERSATION_TICK_INTERVAL_MS;
    public int AGENT_CONVERSATION_ATTEMPT_INTERVAL_MS;
    public int AGENT_CONVERSATION_SESSION_COOLDOWN_MS;
    public int AGENT_CONVERSATION_TURN_INTERVAL_MS;
    public int AGENT_CONVERSATION_SESSION_TIMEOUT_MS;
    public int AGENT_CONVERSATION_MAX_TURNS;
    public int AGENT_CONVERSATION_MAX_VISIBLE_SESSIONS_PER_MAP;
    public int AGENT_DIALOGUE_MAP_MESSAGE_INTERVAL_MS;
