...
public class ServerConfig {
    ...
    public boolean AGENT_SYNTHETIC_MOB_REACTION_ENABLED;
    ...
    public boolean AGENT_MOB_PHYSICS_POC_ENABLED;
    public int AGENT_MOB_PHYSICS_POC_KNOCKBACK_DISTANCE_X;
    public int AGENT_MOB_PHYSICS_POC_KNOCKBACK_DURATION_MS;
    public int AGENT_MOB_PHYSICS_POC_PUBLISH_INTERVAL_MS;
    public int AGENT_MOB_PHYSICS_POC_AGGRO_STEP_X;
    public int AGENT_MOB_PHYSICS_POC_STOP_DISTANCE_X;
    public int AGENT_MOB_PHYSICS_POC_RESUME_DISTANCE_X;
