...
import client.command.commands.gm3.DeleteCharCommand;
...
public class CommandsExecutor {
    ...
    private void registerLv6Commands() {
        ...
        addCommand("serverhealth", 6, ServerHealthCommand.class);
        addCommand("heapdump", 6, HeapDumpCommand.class);
        ...
        addCommand(new String[]{"agentpop", "botpop"}, 6, AgentPopCommand.class);
