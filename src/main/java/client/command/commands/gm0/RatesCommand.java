...
public class RatesCommand extends Command {
    {
        setDescription("Show all world and character rates.");
    }
    ...
    public void execute(Client c, String[] params) {
        ...
        if (YamlConfig.config.server.USE_QUEST_RATE) {
            ...
            showMsg += "Effective QUEST EXP Rate: #e#b" + player.getQuestExpRate() + "x#k#n\r\n";
        }
        showMsg += "\r\nWorld TRAVEL Rate: #e#b" + c.getWorldServer().getTravelRate() + "x#k#n\r\n";
