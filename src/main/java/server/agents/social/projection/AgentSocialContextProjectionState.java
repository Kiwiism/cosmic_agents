...
public final class AgentSocialContextProjectionState {
    static final int MAX_FACTS = 48;
    static final int MAX_MILESTONES = 24;
    public static final AgentCapabilityStateKey<AgentSocialContextProjectionState> STATE_KEY =
            new AgentCapabilityStateKey<>("social.dialogue-context",
                    AgentSocialContextProjectionState.class, AgentSocialContextProjectionState::new);

    private final LinkedHashMap<String, String> facts = new LinkedHashMap<>();
    private final ArrayDeque<AgentSocialContextFact> milestones = new ArrayDeque<>();
    private int agentId;
    ...
    private void milestone(AgentEvent event, String summary) {
        ...
        milestones.addLast(new AgentSocialContextFact(event.occurredAtMs(), event.type(), summary,
    ...
    public record Snapshot(
            ...
            List<AgentSocialContextFact> milestones) {
    }
}
