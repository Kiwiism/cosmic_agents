...
/**
 * Agent-owned adapter for AgentRuntimeEntry-backed inventory and loot cooldown state.
 */
public final class AgentInventoryStateRuntime {
    private AgentInventoryStateRuntime() {
    }
