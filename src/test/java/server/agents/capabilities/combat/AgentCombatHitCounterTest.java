...
class AgentCombatHitCounterTest {
    ...
    @Test
    void appliesShadowPartnerOnlyToRangedRoutes() {
        ...
        assertEquals(1, AgentCombatHitCounter.shadowPartnerHitMultiplier(agent, AgentAttackRoute.CLOSE));
        assertEquals(1, AgentCombatHitCounter.shadowPartnerHitMultiplier(agent, AgentAttackRoute.MAGIC));
