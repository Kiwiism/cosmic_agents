...
characters on the configured real farm map. The population file targets only those 25. After real
...
organic economic supply, and the generated audit manifest says so explicitly.
