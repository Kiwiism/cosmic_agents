...
CHECKPOINTS = {
    ...
    2: {
        "size": (460, 615),
        "centers": [(45, 150), (45, 252), (45, 331), (45, 410), (45, 530)],
        "names": [
            "the-reason-behind-the-mushroom-studies",
            "the-terrorizing-red-ribbon-pigs",
            "the-pigs-are-ruining-the-produce",
            "i-need-an-umbrella",
            "reach-level-15",
        ],
    },
...
def checked_marker(x: int, y: int) -> str:
  ...
  <g aria-label="completed" transform="translate({x} {y})">
    <circle r="14" fill="#42b96b" stroke="#ebfff0" stroke-width="2"/>
...
def current_marker(x: int, y: int) -> str:
  ...
  <g aria-label="current objective" transform="translate({x} {y})">
    <circle r="14" fill="#a8e76f" stroke="#efffdc" stroke-width="2"/>
    <path d="M-3.5-6.5L7 0-3.5 6.5z" fill="#12351e"/>
  </g>"""
