...
- Away/logout, support/heal/buff/proactive toggle, SP variant, help, and equipment recommendation fixed prompt and confirmation lines also live in `AgentDialogueCatalog`.
