...
- Stats/range/build/crit/EXP/supply/meso/movement and drop-or-trade prompt text formatting now lives in `server.agents.capabilities.dialogue.AgentDialogueReportFormatter`.
