...
- Stats/range/build/crit/EXP/supply/meso/movement, drop-or-trade prompt, and selected catalog-template text formatting now lives in `server.agents.capabilities.dialogue.AgentDialogueReportFormatter`.
