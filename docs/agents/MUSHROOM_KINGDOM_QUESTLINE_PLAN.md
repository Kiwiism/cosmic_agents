...
| Optional Victoria delivery | `2320` | Deliver Antidote `4032389` to Bruce `1012111` in Henesys and return without losing mainline context |
...
| Wedding assault | `2330` | Enter `KingPepeAndYetis` instance and defeat one each of `3300005`, `3300006`, `3300007` |
...
- **Instance objective:** `KingPepeAndYetis` and the Prime Minister event are owned instance visits. Entry, boss progress, death, timeout, and re-entry must be journaled and resumable without spawning duplicate instances.
