...
3. Chat/reply/dialogue boundaries. Reply queue primitive has moved to Agent commands; named random dialogue pools have moved to Agent dialogue catalog; movement/follow/fidget, supply-request, query/toggle, respec, and upgrade-request classification have moved to Agent dialogue classifier; item query normalization has moved to Agent dialogue; most chat parsing and many direct response strings remain in bot compatibility code.
